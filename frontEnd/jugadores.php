...
<section id="container">
        ...
        <div id="agregar">
            <form class="pure-form" action="validates/validar-jugadores.php" method="POST">
                <legend>Agregar</legend>
                <fieldset class="pure-group">
                    <input type="text" class="pure-input-1-2" autocomplete="off" placeholder="Nombre del jugador" name="nombre" required/>
                    <input type="text" class="pure-input-1-2" autocomplete="off" placeholder="Edad del jugador" name="edad" required/>
                </fieldset>
        ...
        <div id="modificar">
            <form class="pure-form" action="validates/validar-jugadores.php" method="POST">
                ...
                <fieldset class="pure-group">
                <input type="text" class="pure-input-1-2" autocomplete="off" placeholder="ID del jugador" name="modificar_id" required/>
                <input type="text" class="pure-input-1-2" autocomplete="off" placeholder="Nuevo nombre" name="modificar_nombre" required/>
                <input type="text" class="pure-input-1-2" autocomplete="off" placeholder="Nueva edad" name="modificar_edad" required/>
                </fieldset>
        ...
        <div id="eliminar">
            <form class="pure-form" action="validates/validar-jugadores.php" method="POST">
                ...
                <fieldset class="pure-group">
                    <input type="text" class="pure-input-1-2" autocomplete="off" placeholder="ID jugador" name="id_eliminar" required/>
                </fieldset>
        ...
        <hr>
        <div id="buscar">
            <form class="pure-form" action="validates/validar-jugadores.php" method="GET">
                <legend>Buscar por ID</legend>
                <fieldset class="pure-group">
                <input type="text" class="pure-input-1-2" autocomplete="off" placeholder="ID jugador" name="id_buscar" required/>
                </fieldset>
